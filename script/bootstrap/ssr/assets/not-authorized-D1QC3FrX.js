...
import "@antfu/utils";
const pages401 = "/build/assets/401-C9wCbMBc.png";
const miscObj = "/build/assets/misc-401-object-CG3dJSa0.png";
const _sfc_main = {
  __name: "not-authorized",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/not-authorized.vue");
