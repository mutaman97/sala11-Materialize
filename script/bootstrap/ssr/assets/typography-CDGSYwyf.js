            ...
            if (_push3) {
              ...
              return [
                ...
                createVNode("div", null, [
                  ...
                  createVNode("span", null, "font-size: 0.9375rem / line-height: 1.375rem / font-weight: 500")
                ])
              ];
            }
          }),
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/views/pages/typography/TypographyHeadlines.vue");
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    ...
                    _push4(ssrRenderComponent(VCol, {
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`<p class="text-subtitle-1 text-truncate mb-1"${_scopeId4}> Cupcake ipsum dolor sit amet fruitcake donut chocolate. </p><span${_scopeId4}>font-size: 0.9375rem / line-height: 1.375rem / font-weight: 400</span>`);
                        } else {
                          return [
                    ...
                    _push4(ssrRenderComponent(VCol, {
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`<p class="text-subtitle-2 mb-1"${_scopeId4}> Cupcake ipsum dolor sit amet fruitcake donut chocolate. </p><span${_scopeId4}>font-size: 0.8125rem / line-height: 1.25rem / font-weight: 400</span>`);
                        } else {
                          return [
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/views/pages/typography/TypographyTexts.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/pages/typography.vue");
