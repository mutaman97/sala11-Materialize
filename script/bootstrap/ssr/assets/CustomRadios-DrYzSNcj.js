import { useSSRContext, mergeProps, withCtx, createVNode, renderSlot, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList } from "vue";
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(ssrRenderComponent(VLabel, {
                              class: ["custom-input custom-radio rounded-xl cursor-pointer", props.selectedRadio === item.value ? "active" : ""]
                            }, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`<div data-v-c79ba673${_scopeId4}>`);
                                  _push5(ssrRenderComponent(VRadio, {
                                    value: item.value
                                  }, null, _parent5, _scopeId4));
                                  _push5(`</div>`);
                                  ssrRenderSlot(_ctx.$slots, "default", { item }, () => {
                                    _push5(`<div class="flex-grow-1" data-v-c79ba673${_scopeId4}><div class="d-flex align-center mb-2" data-v-c79ba673${_scopeId4}><h6 class="cr-title text-base" data-v-c79ba673${_scopeId4}>${ssrInterpolate(item.title)}</h6>`);
                                    _push5(ssrRenderComponent(VSpacer, null, null, _parent5, _scopeId4));
                                    if (item.subtitle) {
                                      _push5(`<span class="text-disabled text-sm" data-v-c79ba673${_scopeId4}>${ssrInterpolate(item.subtitle)}</span>`);
                                    } else {
                                      _push5(`<!---->`);
                                    }
                                    _push5(`</div><p class="text-sm text-medium-emphasis mb-0" data-v-c79ba673${_scopeId4}>${ssrInterpolate(item.desc)}</p></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/@core/components/app-form-elements/CustomRadios.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __unplugin_components_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c79ba673"]]);
export {
