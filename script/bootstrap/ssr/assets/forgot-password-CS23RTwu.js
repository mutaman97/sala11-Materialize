...
import { a as authV2ForgotPasswordIllustrationBorderedDark, b as authV2ForgotPasswordIllustrationBorderedLight, c as authV2ForgotPasswordIllustrationDark, d as authV2ForgotPasswordIllustrationLight, e as authV2ForgotPasswordMaskDark, f as authV2ForgotPasswordMaskLight } from "./auth-v2-forgot-password-mask-light-C0VkJFTx.js";
                                                ...
                                                _push8(ssrRenderComponent(_component_RouterLink, {
                                                  ...
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      ...
                                                      _push9(`<span${_scopeId8}>Back to login</span>`);
                                                    } else {
                                                      return [
                                                        createVNode(VIcon, {
                                                          icon: "ri-arrow-left-s-line",
                                                        ...
                                                        createVNode("span", null, "Back to login")
                                                      ];
                                                    }
                                                  }),
                                                  _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/forgot-password.vue");
