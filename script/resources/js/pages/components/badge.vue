    ...
    <VRow class="match-height">
        ...
        >
            ...
            <AppCardCode
                ...
                :code="demoCode.style"
            >
                <p>You can use various props like <code>bordered</code>, <code>dot</code>, <code>inline</code>, <code>rounded</code>
                    etc. to style the badge.</p>
        ...
        >
            ...
            >
                <p>You can use <code>location</code> prop to change the position of the badge. Possible values are
                    <code>top-end</code>, <code>bottom-end</code>, <code>bottom-start</code>, <code>top-start</code>.
                </p>
