...
<template>
    <VRow class="match-height">
        ...
        >
            ...
            >
                <p>The primary value is controlled by <code>v-model</code>, whereas the buffer is controlled by the
        ...
        >
            ...
            >
                <p>for continuously animating progress bar,use prop <code>indeterminate</code>. This indicates
        ...
        >
            ...
            >
                <p>Use prop <code>reverse</code> to animate continuously in reverse direction. The component also has
                    RTL support.</p>
        ...
        >
            ...
            >
                <p>The <code> rounded </code> prop is used to apply a border radius to the v-progress-linear component.
                </p>
