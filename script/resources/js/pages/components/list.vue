    ...
    <VRow class="match-height">
        ...
        >
            ...
            <AppCardCode
                ...
                :code="demoCode.basic"
            >
                <VCardText><code>v-list</code> component can contain an avatar, content, actions and much more.
                </VCardText>
        ...
        >
            ...
            <AppCardCode
                ...
                no-padding
            >
                <VCardText>Use <code>density</code> prop to adjusts the spacing within the component. Available options
        ...
        >
            ...
            <AppCardCode
                ...
                :code="demoCode.nav"
            >
                <VCardText>Lists can receive an alternative <code>nav</code> styling that reduces the width <code>v-list-item</code>
        ...
        >
            ...
            >
                <VCardText>A <code>three-line</code> list with actions. Utilizing <code>v-list-group</code>, easily
        ...
        >
            ...
            >
                <VCardText>Lists can contain subheaders, dividers, and can contain 1 or more lines. The subtitle will
        ...
        >
            ...
            >
                <VCardText>For three line lists, the subtitle will clamp vertically at 2 lines and then ellipsis. This
