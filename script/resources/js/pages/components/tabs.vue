...
<template>
    <VRow class="match-height">
        ...
        >
            ...
            >
                <p>Use our custom class <code>.v-tabs-pill</code> along with <code>v-tabs</code> component to style pill
                    tabs.</p>
        ...
        >
            ...
            >
                <p><code>prev-icon</code> and <code>next-icon</code> props can be used for applying custom pagination
                    icons.</p>
        ...
        <VCol cols="12">
            ...
            <AppCardCode
                ...
                :code="demoCode.fixed"
            >
                <p>The <code>fixed-tabs</code> prop forces <code>v-tab</code> to take up all available space up to the
                    maximum width (300px).</p>
        ...
        >
            ...
            >
                <p>Tabs can be dynamically added and removed. This allows you to update to any number and the <code>v-tabs</code>
                    component will react.</p>
