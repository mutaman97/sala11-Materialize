    ...
    <VRow class="match-height">
        ...
        >
            ...
            <AppCardCode
                ...
                :code="demoCode.label"
            >
                <p>Label chips use the <code>v-card</code> border-radius. Use <code>label</code> prop to create label
                    chips.</p>
        ...
        >
            ...
            <AppCardCode
                ...
                :code="demoCode.sizes"
            >
                <p>The <code>v-chip</code> component can have various sizes from <code>x-small</code> to
                    <code>x-large</code>.</p>
