...
import authV2VerifyEmailIllustrationBorderedDark
    from '@images/pages/auth-v2-verify-email-illustration-bordered-dark.png'
import authV2VerifyEmailIllustrationBorderedLight
    from '@images/pages/auth-v2-verify-email-illustration-bordered-light.png'
            ...
            >
                <VCardText>
                    ...
                    <p class="mb-5">
                        ...
                        class="text-high-emphasis font-weight-medium">hello@example.com</span> Please follow the link
                        inside to continue.
                    </p>
