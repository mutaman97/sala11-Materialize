...
<template>
    <VRow class="match-height">
        ...
        >
            ...
            >
                <p>The <code>v-rating</code> component can be colored as you want, you can set both selected and not
                    selected colors.</p>
        ...
        >
            ...
            <AppCardCode
                ...
                :code="demoCode.size"
            >
                <p>Utilize the same sizing classes available in <code>v-icon</code> or provide your own with the <code>size</code>
                    prop.</p>
        ...
        >
            ...
            >
                <p>Use <code>clearable</code> prop to allows for the component to be cleared. Triggers when the icon
                    containing the current value is clicked.</p>
        ...
        >
            ...
            >
                <p>The <code>half-increments</code> prop increases the granularity of the ratings, allow for .5 values
                    as well.</p>
        ...
        >
            ...
            >
                <p>Slots enable advanced customization possibilities and provide you with more freedom in how you
                    display the rating.</p>
