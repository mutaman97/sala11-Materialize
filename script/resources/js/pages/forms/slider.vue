...
<template>
    <VRow class="match-height">
        ...
        >
            ...
            >
                <p>You can set the colors of the slider using the props <code>color</code>, <code>track-color</code> and
                    <code>thumb-color</code>.</p>
        ...
        >
            ...
            <AppCardCode
                ...
                :code="demoCode.icons"
            >
                <p>You can add icons to the slider with the <code>append-icon</code> and <code>prepend-icon</code>
                    props.</p>
        ...
        >
            ...
            <AppCardCode
                ...
                :code="demoCode.step"
            >
                <p>Using the <code>step</code> prop you can control the precision of the slider, and how much it should
                    move each step.</p>
        ...
        >
            ...
            <AppCardCode
                ...
                :code="demoCode.size"
            >
                <p>Use <code>thumb-size</code>, <code>tick-size</code>, and <code>track-size</code> prop to increase and
                    decrease the size of thumb, tick and track. </p>
        ...
        >
            ...
            >
                <p>Sliders can be combined with other components in its <code>append</code> slot, such as <code>v-text-field</code>,
                    to add additional functionality to the component.</p>
        ...
        >
            ...
            >
                <p>Use slots such as <code>append</code> and <code>prepend</code> to easily customize the
                    <code>v-slider</code> to fit any situation.</p>
