...
<template>
    <VRow class="match-height">
        ...
        >
            ...
            >
                <p>The <code>density</code> prop decreases the height of the text field based upon 1 of 3 levels of
                    density; <code>default</code>, <code>comfortable</code>, and <code>compact</code>.</p>
        ...
        <VCol cols="12">
            ...
            >
                <p>Use <code>solo</code>, <code>filled</code>, <code>outlined</code>, <code>plain</code> and <code>underlined</code>
                    option of <code>variant</code> prop to change the look of the textfield. </p>
        ...
        >
            ...
            <AppCardCode
                ...
                :code="demoCode.icons"
            >
                <p>You can add icons to the text field with <code>prepend-icon</code>, <code>append-icon</code> and
                    <code>append-inner-icon</code> and <code>prepend-inner-icon</code> props.</p>
        ...
        >
            ...
            >
                <p>The <code>prefix</code> and <code>suffix</code> properties allows you to prepend and append inline
                    non-modifiable text next to the text field.</p>
        ...
        >
            ...
            >
                <p><code>click:prepend</code>, <code>click:append</code>, <code>click:append-inner</code>, and <code>click:clear</code>
                    will be emitted when you click on the respective icon</p>
        ...
        >
            ...
            >
                <p>Using the HTML input <code>type</code> password can be used with an appended icon and callback to
                    control the visibility.</p>
        ...
        >
            ...
            >
                <p>Instead of using <code>prepend</code>/<code>append</code>/<code>append-inner</code> icons you can use
                    slots to extend input's functionality.</p>
