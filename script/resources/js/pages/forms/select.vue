    ...
    <VRow>
        ...
        >
            ...
            <AppCardCode
                ...
                :code="demoCode.basic"
            >
                <p>Select fields components are used for collecting user provided information from a list of
                    options.</p>
                <DemoSelectBasic/>
            </AppCardCode>
        </VCol>
        ...
        >
            ...
            >
                <p>You can use <code>density</code> prop to reduce the field height and lower max height of list items.
                </p>
                <DemoSelectDensity/>
            </AppCardCode>
        </VCol>
        ...
        <VCol cols="12">
            ...
            >
                <p>
                    ...
                    <code>plain</code> options of <code>variant</code> prop to change appearance of select.
                </p>
        ...
        >
            ...
            >
                <p>You can specify the specific properties within your items array that correspond to the title and
                    value fields. In this example we also use the return-object prop which will return the entire object
                    of the selected item on selection.</p>
        ...
        >
            ...
            >
                <p>The <code>selection</code> slot can be used to customize the way selected values are shown in the
                    input.</p>
