...
<template>
    <VRow class="match-height">
        ...
        >
            ...
            >
                <p>Use <code>density</code> prop to reduces the input height. Available options are:
        ...
        >
            ...
            >
                <p>Checkboxes can be colored by using any of the builtin colors and contextual names using the <code>color</code>
                    prop.</p>
        ...
        >
            ...
            >
                <p>Use <code>false-value</code> and <code>true-value</code> prop to sets value for truthy and falsy
                    state</p>
        ...
        >
            ...
            >
                <p><code>v-checkbox</code> can have different states such as <code>default</code>, <code>disabled</code>,
                    and <code>indeterminate</code>.</p>
        ...
        >
            ...
            >
                <p>You can place <code>v-checkbox</code> in line with other components such as <code>v-text-field</code>.
                </p>
