            ...
            <VCard>
                ...
                <VCardText>
                    <div class="d-flex align-center justify-space-between flex-wrap gap-x-2 gap-y-4">
                        ...
                        <div>
                            <div>
                                <span class="text-high-emphasis font-weight-medium">Start Date:</span> {{
                                    data.startDate
                                }}
                            </div>
                ...
                <VCardText>
                    ...
                    <div
                        class="d-flex align-center justify-space-between flex-wrap text-caption text-medium-emphasis mt-4 mb-2">
