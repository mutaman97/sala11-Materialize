                    ...
                    <VCardText>
                        <div>
                            ...
                            <div class="text-body-1">
                                ...
                                constantly work on to make the template better. I am so thankful for this. Also, in the
                                past, they had responded well to my tickets. Thank you for this great theme, for such an
                                amazing support, for the better updates. I wish I could rate this for so many times. I
                                highly recommend this template!
                            </div>
                        </div>
                    </VCardText>
                </VCard>
                ...
                <VCard class="mb-10 mt-n4">
                    ...
                    <VCardText>
                        <p class="mb-3">
                            ...
                            of the corporate objectives and therefore also project objectives. The components of the
                            project process are
                        </p>
