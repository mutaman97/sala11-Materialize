...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'dashboards-merchant-dashboard': RouteRecordInfo<'dashboards-merchant-dashboard', '/dashboards/merchant/dashboard', Record<never, never>, Record<never, never>>,
    'dashboards-merchant-setting': RouteRecordInfo<'dashboards-merchant-setting', '/dashboards/merchant/setting', Record<never, never>, Record<never, never>>,
    'dashboards-seller-dashboard': RouteRecordInfo<'dashboards-seller-dashboard', '/dashboards/seller/dashboard', Record<never, never>, Record<never, never>>,
    ...
    'partner-dashboard': RouteRecordInfo<'partner-dashboard', '/partner/dashboard', Record<never, never>, Record<never, never>>,
    'partner-setting': RouteRecordInfo<'partner-setting', '/partner/setting', Record<never, never>, Record<never, never>>,
    'register': RouteRecordInfo<'register', '/register', Record<never, never>, Record<never, never>>,
    'seller-calendar': RouteRecordInfo<'seller-calendar', '/seller/calendar', Record<never, never>, Record<never, never>>,
    'seller-customer-details-id': RouteRecordInfo<'seller-customer-details-id', '/seller/customer/details/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'seller-customer-list': RouteRecordInfo<'seller-customer-list', '/seller/customer/list', Record<never, never>, Record<never, never>>,
    'seller-dashboard': RouteRecordInfo<'seller-dashboard', '/seller/dashboard', Record<never, never>, Record<never, never>>,
    'seller-manage-review': RouteRecordInfo<'seller-manage-review', '/seller/manage-review', Record<never, never>, Record<never, never>>,
    'seller-order-details-id': RouteRecordInfo<'seller-order-details-id', '/seller/order/details/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'seller-order-list': RouteRecordInfo<'seller-order-list', '/seller/order/list', Record<never, never>, Record<never, never>>,
    'seller-product': RouteRecordInfo<'seller-product', '/seller/product', Record<never, never>, Record<never, never>>,
    'seller-product-category-list': RouteRecordInfo<'seller-product-category-list', '/seller/product/category-list', Record<never, never>, Record<never, never>>,
    'seller-product-create': RouteRecordInfo<'seller-product-create', '/seller/product/create', Record<never, never>, Record<never, never>>,
    'seller-product-list': RouteRecordInfo<'seller-product-list', '/seller/product/list', Record<never, never>, Record<never, never>>,
    'seller-product-newindex': RouteRecordInfo<'seller-product-newindex', '/seller/product/newindex', Record<never, never>, Record<never, never>>,
    'seller-referrals': RouteRecordInfo<'seller-referrals', '/seller/referrals', Record<never, never>, Record<never, never>>,
    'seller-settings': RouteRecordInfo<'seller-settings', '/seller/settings', Record<never, never>, Record<never, never>>,
