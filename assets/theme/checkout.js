...
$('.getway').on('click',function(){
	...
	name != '' ? $('.name_area').show() : $('.name_area').hide();
	account_number != '' ? $('.account_number_area').show() : $('.account_number_area').hide();
	branch != '' ? $('.branch_area').show() : $('.branch_area').hide();
});
